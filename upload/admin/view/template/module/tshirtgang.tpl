...
<div id="content">
  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-tshirtgang" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="entry-api_id"><span data-toggle="tooltip" title="<?php echo $help_api_id; ?>"><?php echo $entry_api_id; ?></span></label>
            <div class="col-sm-10">
              <input type="text" name="tshirtgang_api_id" value="<?php echo $tshirtgang_api_id; ?>" placeholder="<?php echo $entry_api_id; ?>" id="entry-api_id" class="form-control"/>
              <?php if ($error_api_id) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" value="2.0.3" readonly>
            </div>
          </div>
          <div class="form-group">
    ...
    <div id="tshirtgang-installdocs" >
      ...
      <h3>API key & ID</h3>
      <section>
        <p>Login to your Tshirtgang account and obtain an API key & ID. These information will be used by opencart so it can communicate with the main tshirtgang server to access your products, sales and other information.</p>
      </section>
      <h3>Add Products</h3>
      <section>
